%Inputs go here
calibration_filename_base = 'C:\Users\apcwy\Dropbox (The University of Manchester)\Physics PhD\MIT_2022\TGS_Data\Tungsten_Calibration\2022-01-13\Tungsten_Calibration-2022-01-13-06.40um-spot00';
pname = 'C:\Users\apcwy\Dropbox (The University of Manchester)\Physics PhD\MIT_2022\TGS_Data\compiled_newly_irradiated_tungsten'; %ADJUST
outputFileName = 'W_damaged_TGS_Outputs.txt';
%First part of file name and number of spots
str_base='Tungsten_Irradiation_5-2022-01-13-06.40um-irradiated_'; 
spots=1:14;
dir=cd(pname);
cd(dir)
...
%     end
    close all
    pos_str=strcat(str_base,num2str(spots(jj)+adder),'-POS-1.txt');
    neg_str=strcat(str_base,num2str(spots(jj)+adder),'-NEG-1.txt');
